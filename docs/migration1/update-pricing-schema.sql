-- Add description column to pricing_catalog table and update data structure
...
-- Step 3: Insert new structured data
...
SELECT description, item_name, base_price FROM public.pricing_catalog WHERE service_type = 'insulation' ORDER BY base_price;
